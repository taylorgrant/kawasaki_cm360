...
gmail_update_meta <- function(vehicle) {
  ...
  gmailr::gm_auth_configure(path = "/home/rstudio/R/kawasaki_cm360/credentials/gsp21-gmail.json")
  ...
  base::message("Meta daily data updated successfully.")
}
